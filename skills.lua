...
skills.weapon_skills = {
    ...
    [9] = {en='Asuran Fists',skillchain={'Gravitation','Liquefaction'},weapon='Karambit'},
    [10] = {en='Final Heaven',skillchain={'Light','Fusion'},weapon='Spharai'},
    [11] = {en='Ascetic\'s Fury',skillchain={'Fusion','Transfixion'},weapon='Glanzfaust'},
    [12] = {en='Stringing Pummel',skillchain={'Gravitation','Liquefaction'},weapon='Kenkonken'},
    [13] = {en='Tornado Kick',skillchain={'Induration','Detonation','Impaction'}},
    [14] = {en='Victory Smite',skillchain={'Light','Fragmentation'},weapon='Verethragna'},
    ...
    [25] = {en='Evisceration',skillchain={'Gravitation','Transfixion'},weapon='Tauret'},
    [26] = {en='Mercy Stroke',skillchain={'Darkness','Gravitation'},weapon='Mandau'},
    [27] = {en='Mandalic Stab',skillchain={'Fusion','Compression'},weapon='Vajra'},
    [28] = {en='Mordant Rime',skillchain={'Fragmentation','Distortion'},weapon='Carnwenhan'},
    [29] = {en='Pyrrhic Kleos',skillchain={'Distortion','Scission'},weapon='Terpsichore'},
    [30] = {en='Aeolian Edge',skillchain={'Scission','Detonation','Impaction'}},
    [31] = {en='Rudra\'s Storm',skillchain={'Darkness','Distortion'},weapon='Twashtar'},
    ...
    [42] = {en='Savage Blade',skillchain={'Fragmentation','Scission'},weapon='Naegling'},
    [43] = {en='Knights of Round',skillchain={'Light','Fusion'},weapon='Excalibur'},
    [44] = {en='Death Blossom',skillchain={'Fragmentation','Distortion'},weapon='Murgleis'},
    [45] = {en='Atonement',skillchain={'Fusion','Reverberation'},weapon='Burtgang'},
    [46] = {en='Expiacion',skillchain={'Distortion','Scission'},weapon='Tizona'},
    ...
    [56] = {en='Ground Strike',skillchain={'Fragmentation','Distortion'},weapon='Nandaka'},
    [57] = {en='Scourge',skillchain={'Light','Fusion'},weapon='Ragnarok'},
    [58] = {en='Herculean Slash',skillchain={'Induration','Detonation','Impaction'}},
    [59] = {en='Torcleaver',skillchain={'Light','Distortion'},weapon='Caladbolg'},
    [60] = {en='Resolution',skillchain={'Fragmentation','Scission'},aeonic='Light',weapon='Lionheart'},
    [61] = {en='Dimidiation',skillchain={'Light','Fragmentation'},weapon='Epeolatry'},
    [62] = {en='Fimbulvetr',skillchain={'Detonation','Compression','Distortion'},weapon='Helheim'},
    ...
    [72] = {en='Decimation',skillchain={'Fusion','Reverberation'},weapon='Dolichenus'},
    [73] = {en='Onslaught',skillchain={'Darkness','Gravitation'},weapon='Guttler'},
    [74] = {en='Primal Rend',skillchain={'Gravitation','Reverberation'},weapon='Aymur'},
    [75] = {en='Bora Axe',skillchain={'Scission','Detonation'}},
    [76] = {en='Cloudsplitter',skillchain={'Darkness','Fragmentation'},weapon='Farsha'},
    [77] = {en='Ruinator',skillchain={'Distortion','Detonation'},aeonic='Darkness',weapon='Tri-Edge'},
    [78] = {en='Blitz',skillchain={'Liquefaction','Impaction','Fragmentation'},weapon='Spalirisos'},
    ...
    [88] = {en='Steel Cyclone',skillchain={'Distortion','Detonation'},weapon='Lycurgos'},
    [89] = {en='Metatron Torment',skillchain={'Light','Fusion'},weapon='Bravura'},
    [90] = {en='King\'s Justice',skillchain={'Fragmentation','Scission'},weapon='Conqueror'},
    [91] = {en='Fell Cleave',skillchain={'Scission','Detonation','Impaction'}},
    [92] = {en='Ukko\'s Fury',skillchain={'Light','Fragmentation'},weapon='Ukonvasara'},
    [93] = {en='Upheaval',skillchain={'Fusion','Compression'},aeonic='Light',weapon='Chango'},
    [94] = {en='Disaster',skillchain={'Transfixion','Scission','Gravitation'},weapon='Laphria'},
    ...
    [104] = {en='Spiral Hell',skillchain={'Distortion','Scission'},weapon='Drepanum'},
    [105] = {en='Catastrophe',skillchain={'Darkness','Gravitation'},weapon='Apocalypse'},
    [106] = {en='Insurgency',skillchain={'Fusion','Compression'},weapon='Liberator'},
    [107] = {en='Infernal Scythe',skillchain={'Compression','Reverberation'}},
    [108] = {en='Quietus',skillchain={'Darkness','Distortion'},weapon='Redemption'},
    [109] = {en='Entropy',skillchain={'Gravitation','Reverberation'},aeonic='Darkness',weapon='Anguta'},
    [110] = {en='Origin',skillchain={'Induration','Reverberation','Fusion'},weapon='Foenaria'},
    ...
    [120] = {en='Impulse Drive',skillchain={'Gravitation','Induration'},weapon='Shining One'},
    [121] = {en='Geirskogul',skillchain={'Light','Distortion'},weapon='Gungnir'},
    [122] = {en='Drakesbane',skillchain={'Fusion','Transfixion'},weapon='Ryunohige'},
    [123] = {en='Sonic Thrust',skillchain={'Transfixion','Scission'}},
    [124] = {en='Camlann\'s Torment',skillchain={'Light','Fragmentation'},weapon='Rhongomiant'},
    [125] = {en='Stardiver',skillchain={'Gravitation','Transfixion'},aeonic='Darkness',weapon='Trishula'},
    [126] = {en='Diarmuid',skillchain={'Transfixion','Scission','Gravitation'},weapon='Gae Buide'},
    ...
    [136] = {en='Blade: Ku',skillchain={'Gravitation','Transfixion'},weapon='Gokotai'},
    [137] = {en='Blade: Metsu',skillchain={'Darkness','Fragmentation'},weapon='Kikoku'},
    [138] = {en='Blade: Kamu',skillchain={'Fragmentation','Compression'},weapon='Nagi'},
    [139] = {en='Blade: Yu',skillchain={'Reverberation','Scission'}},
    [140] = {en='Blade: Hi',skillchain={'Darkness','Gravitation'},weapon='Kannagi'},
    [141] = {en='Blade: Shun',skillchain={'Fusion','Impaction'},aeonic='Light',weapon='Heishi Shorinken'},
    [142] = {en='Zesho Meppo',skillchain={'Induration','Reverberation','Fusion'},weapon='Dokoku'},
    ...
    [152] = {en='Tachi: Kasha',skillchain={'Fusion','Compression'},weapon='Hachimonji'},
    [153] = {en='Tachi: Kaiten',skillchain={'Light','Fragmentation'},weapon='Amanomurakumo'},
    [154] = {en='Tachi: Rana',skillchain={'Gravitation','Induration'},weapon='Kogarasumaru'},
    [155] = {en='Tachi: Ageha',skillchain={'Compression','Scission'}},
    [156] = {en='Tachi: Fudo',skillchain={'Light','Distortion'},weapon='Masamune'},
    ...
    [159] = {en='Tachi: Mumei',skillchain={'Detonation','Compression','Distortion'},weapon='Kusanagi'},
    ...
    [169] = {en='Black Halo',skillchain={'Fragmentation','Compression'},weapon='Maxentius'},
    [170] = {en='Randgrith',skillchain={'Light','Fragmentation'},weapon='Mjollnir'},
    ...
    [175] = {en='Exudation',skillchain={'Darkness','Fragmentation'},weapon='Idris'},
    ...
    [184] = {en='Retribution',skillchain={'Gravitation','Reverberation'},weapon='Xoanon'},
    [185] = {en='Gate of Tartarus',skillchain={'Darkness','Distortion'},weapon='Claustrum'},
    [186] = {en='Vidohunir',skillchain={'Fragmentation','Distortion'},weapon='Laevateinn'},
    [187] = {en='Garland of Bliss',skillchain={'Fusion','Reverberation'},weapon='Nirvana'},
    [188] = {en='Omniscience',skillchain={'Gravitation','Transfixion'},weapon='Tupsimati'},
    ...
    [199] = {en='Empyreal Arrow',skillchain={'Fusion','Transfixion'},weapon='Ullr'},
    [200] = {en='Namas Arrow',skillchain={'Light','Distortion'},weapon='Yoichinoyumi'},
    [201] = {en='Refulgent Arrow',skillchain={'Reverberation','Transfixion'}},
    [202] = {en='Jishnu\'s Radiance',skillchain={'Light','Fusion'},weapon='Gandiva'},
    [203] = {en='Apex Arrow',skillchain={'Fragmentation','Transfixion'},aeonic='Light',weapon='Fail-Not'},
    [204] = {en='Sarv',skillchain={'Transfixion','Scission','Gravitation'},weapon='Pinaka'},
    ...
    [216] = {en='Coronach',skillchain={'Darkness','Fragmentation'},weapon='Annihilator'},
    [217] = {en='Trueflight',skillchain={'Fragmentation','Scission'},weapon='Gastraphetes'},
    [218] = {en='Leaden Salute',skillchain={'Gravitation','Transfixion'},weapon='Death Penalty'},
    [219] = {en='Numbing Shot',skillchain={'Induration','Detonation','Impaction'}},
    [220] = {en='Wildfire',skillchain={'Darkness','Gravitation'},weapon='Armageddon'},
    [221] = {en='Last Stand',skillchain={'Fusion','Reverberation'},aeonic='Light',weapon='Fomalhaut'},
    [222] = {en='Terminus',skillchain={'Induration','Reverberation','Fusion'},weapon='Earp'},
    [224] = {en='Exenterator',skillchain={'Fragmentation','Scission'},aeonic='Light',weapon='Aeneas'},
    [225] = {en='Chant du Cygne',skillchain={'Light','Distortion'},weapon='Almace'},
    ...
    [231] = {en='Maru Kala',skillchain={'Detonation','Compression','Distortion'},weapon='Varga Purnikawa'},
    [232] = {en='Ruthless Stroke',skillchain={'Liquefaction','Impaction','Fragmentation'},weapon='Mpu Gandring'},
    [233] = {en='Imperator',skillchain={'Detonation','Compression','Distortion'},weapon='Caliburnus'},
    [234] = {en='Dagda',skillchain={'Transfixion','Scission','Gravitation'},weapon='Lorg Mor'},
    [235] = {en='Oshala',skillchain={'Induration','Reverberation','Fusion'},weapon='Opashoro'},
